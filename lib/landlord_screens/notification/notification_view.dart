  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading: InkWell(
          onTap: () {
            Get.back(result: notifCntrl.isRefreshScreen.value);
          },
          child: Padding(
                              ...
                              return notifCntrl.items[index]['notification_type'] ==
                                  ...
                                  : notifCntrl.items[index]['notification_type'] ==
                                      ...
                                      ? NotificationWidget().notifRequestList(
                                          desc: notifCntrl.items[index]['description'] ??
                                              "",
